            ...
            <table className="table-auto whitespace-nowrap w-full h-full">
                ...
                return (
                        <tr key={coin.id}>
                            ...
                            <td className={`py-4 pr-4 ${coin.price_change_percentage_24h >= 0? 'text-green-400': 'text-red-400' }`}><Link to={`crypto/${coin.id}`}>{coin.price_change_percentage_24h.toFixed(2)}%</Link></td>
